...
const { exportOrderHistoryCsv, ORDER_HISTORY_EXPORT_PAGE_SIZE } = await import(
...
describe("exportOrderHistoryCsv", () => {
  afterEach(() => {
    mock.restore()
    orderRepository.findAllOrdersOrderByIdAsc.mockClear()
  })
  ...
  it("注文を行アイテム付きでCSV行に変換する", async () => {
    ...
    expect(result.csv).toBe(
      `${[
        ...
        "1,2024-01-01T18:00:00+09:00,2024-01-01T19:00:00+09:00,completed,Alice,1500,2,2,,Cookie,500,1,500",
        "2,2024-01-02T18:00:00+09:00,2024-01-02T18:30:00+09:00,pending,,1000,1,1,20,Tea,1000,1,1000",
      ].join("\n")}\n`,
    )
  })
